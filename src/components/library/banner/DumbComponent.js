            ...
            <Container maxWidth={maxWidthContainer}>
                <Box className={classes.bannerContent}>
                    <Grid item xs={12} sm={6} className="info">
                        {heading.length > 0 && <Typography variant={variant} className={`${classes.heading} heading`}>
                            {heading}
                        </Typography>
}
                        {paragraph.length > 0 && <p className={classes.paragraph}>
                            {paragraph}
                        </p>}
                        {isButton && <Box display={'flex'} justifyContent='center'>
                            <Button
